...
namespace MyAspTest.Models
{
    ...
    {
        //TODO: Пагинация с отрисовкой первых и последний страниц
        ...
        public int Offset { get; set; } // смещение записей относительно первой текущей записи.
        ...
        private void ComputePages()
        {
            ...
            else
            {
                ...
                for (int i = 1 + c, l = c + 15; i <= l; i++)
                    ...
                    { "action", ActionName }, { "Page", i } }, RouteParams, Params)
                    });
            }
        ...
        //
                ...
                for (var i = 0; i < Pages.Count; i++)
                {
                    ...
                    else if (i >= 12 && rightDotPage)
                    {
                        if (i == 14)
                        {
                            ...
                            Pages[i].RouteValues = Merge(new Dictionary<string, object>
                        { { "controller", ControllerName }, { "action", ActionName },
                        { "Page", LastPage } }, RouteParams, Params);
                        }
                        else if (i == 13)
                        {
                            ...
                            Pages[i].RouteValues = Merge(new Dictionary<string, object>
                        { { "controller", ControllerName }, { "action", ActionName },
                        { "Page", LastPage - 1 } }, RouteParams, Params);
                        }
                        else if (i == 12)
                        {
                            Pages[i].Caption = "..";
            ...
            Pages.Insert(0, new Page
            {
                ...
                RouteValues = Merge(new Dictionary<string, object>
           { { "controller", ControllerName }, { "action", ActionName },
           { "Page", PrevPage } }, RouteParams, Params)
            });
            ...
            Pages.Add(new Page
            {
                ...
                RouteValues = Merge(new Dictionary<string, object>
            { { "controller", ControllerName }, { "action", ActionName },
            { "Page", NextPage } }, RouteParams, Params)
            });
        }
    ...
    public class Page
    {
        ...
        // совокупность всех параметров ControllerName, ActionName, RouteParams, Params и Value
    }
